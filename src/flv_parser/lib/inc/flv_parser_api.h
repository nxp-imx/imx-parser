...
typedef int32 FLVPARSER_ERR_CODE;
...
/**
 * function to get the FLV core parser version.
 *
...
/**
 * function to create the FLV core parser.
 *
 * @param stream [in]   Source stream of the FLV file.
 ...
 *
 * @param context [in]  Wrapper context for the callback functions. FLV parser never modify it.
 * @param parserHandle [out] Handle of the FLV core parser if succeeds. NULL for failure.
 * @return
 */

EXTERN int32 FLVCreateParser(bool isLive, FslFileStream* streamOps, ParserMemoryOps* memOps,
                             ParserOutputBufferOps* outputBufferOps, void* context,
                             FslParserHandle* parserHandle);

EXTERN int32 FLVCreateParser2(uint32 flags, FslFileStream* streamOps, ParserMemoryOps* memOps,
                              ParserOutputBufferOps* outputBufferOps, void* context,
                              FslParserHandle* parserHandle);

/**
 * Function to delete the FLV core parser.
 *
 * @param parserHandle Handle of the FLV core parser.
 * @return
 */
EXTERN int32 FLVDeleteParser(FslParserHandle parserHandle);
 ...
 * @return
 */
EXTERN int32 FLVIsSeekable(FslParserHandle parserHandle, bool* seekable);
 ...
 * @return
 */
EXTERN int32 FLVGetNumTracks(FslParserHandle parserHandle, uint32* numTracks);
 ...
 * @return
 */
EXTERN int32 FLVGetUserData(FslParserHandle parserHandle, uint32 userDataId, uint8** buffer,
                            uint32* size);
 ...
 * @return
 */
EXTERN int32 FLVGetDuration(FslParserHandle parserHandle, uint64* usDuration);
 ...
 * @return
 */
EXTERN int32 FLVGetTrackDuration(FslParserHandle parserHandle, uint32 trackNum, uint64* usDuration);
 ...
 * @return
 */
EXTERN int32 FLVGetTrackType(FslParserHandle parserHandle, uint32 trackNum, uint32* mediaType,
 ...
 * @return
 */
EXTERN int32 FLVGetBitRate(FslParserHandle parserHandle, uint32 trackNum, uint32* bitrate);
...
EXTERN int32 FLVGetVideoFrameRate(FslParserHandle parserHandle, uint32 trackNum, uint32* rate,
                                  uint32* scale);

// EXTERN int32 FLVGetVideoFrameDuration(FslParserHandle parserHandle, uint32 trackNum, uint64
// *usDuration);
 ...
 * @return
 */
EXTERN int32 FLVGetVideoFrameWidth(FslParserHandle parserHandle, uint32 trackNum, uint32* width);
 ...
 * @return
 */
EXTERN int32 FLVGetVideoFrameHeight(FslParserHandle parserHandle, uint32 trackNum, uint32* height);
 ...
 * @return
 */
EXTERN int32 FLVGetAudioNumChannels(FslParserHandle parserHandle, uint32 trackNum,
                                    uint32* numChannels);
 ...
 * @return
 */
EXTERN int32 FLVGetAudioSampleRate(FslParserHandle parserHandle, uint32 trackNum,
                                   uint32* sampleRate);
 ...
 * @return
 */
EXTERN int32 FLVGetAudioBitsPerSample(FslParserHandle parserHandle, uint32 trackNum,
 ...
 * @return
 */
EXTERN int32 FLVGetTextTrackWidth(FslParserHandle parserHandle, uint32 trackNum, uint32* width);
 ...
 * @return
 */
EXTERN int32 FLVGetTextTrackHeight(FslParserHandle parserHandle, uint32 trackNum, uint32* height);
 ...
 *
 */
EXTERN int32 FLVSetReadMode(FslParserHandle parserHandle, uint32 readMode);
 ...
 * @return
 */
EXTERN int32 FLVGetReadMode(FslParserHandle parserHandle, uint32* readMode);
 ...
 * @return
 */
EXTERN int32 FLVEnableTrack(FslParserHandle parserHandle, uint32 trackNum, bool enable);
...
EXTERN int32 FLVGetFileNextSample(FslParserHandle parserHandle, uint32* trackNum,
 ...
 */
EXTERN int32 FLVSeek(FslParserHandle parserHandle, uint32 trackNum, uint64* usTime, uint32 flag);

EXTERN int32 FLVGetFileNextSyncSample(FslParserHandle parserHandle, uint32 direction,
                                      uint32* trackNum, uint8** sampleBuffer, void** bufferContext,
                                      uint32* dataSize, uint64* usStartTime, uint64* usDuration,
                                      uint32* flags);

EXTERN int32 FLVGetDecoderSpecificInfo(FslParserHandle parserHandle, uint32 trackNum, uint8** data,
                                       uint32* size);
