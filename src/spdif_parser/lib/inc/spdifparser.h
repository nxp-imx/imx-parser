...
typedef SPDIF_RET_TYPE (*spdif_parser_open_t)(spdif_parser_handle* p_handle,
...
typedef void (*spdif_parser_set_iec958_type_t)(spdif_parser_handle handle,
                                               SPDIF_AUDIO_FORMAT_TYPE audio_type);
typedef SPDIF_PARSER_MODE (*spdif_parser_get_mode_t)(spdif_parser_handle handle);
typedef SPDIF_RET_TYPE (*spdif_parser_search_header_t)(spdif_parser_handle handle, uint8_t* p_buf,
...
typedef SPDIF_RET_TYPE (*spdif_parser_read_t)(spdif_parser_handle handle, uint8_t* src,
                                              uint8_t* dst, uint32_t src_len, uint32_t* p_dst_len);
typedef SPDIF_RET_TYPE (*spdif_parser_read_with_sync_t)(spdif_parser_handle handle, uint8_t* src,
                                                        uint8_t* dst, uint32_t src_len,
                                                        uint32_t* p_dst_len,
                                                        uint32_t* p_out_src_pos);
typedef void (*spdif_parser_get_audio_info_t)(spdif_parser_handle handle,
...
typedef SPDIF_RET_TYPE (*spdif_parser_set_default_word_length_t)(spdif_parser_handle handle,
...
SPDIF_RET_TYPE spdif_parser_search_header(spdif_parser_handle handle, uint8_t* p_buf, uint32_t len,
                                          uint32_t* p_out_pos);
...
SPDIF_RET_TYPE spdif_parser_read(spdif_parser_handle handle, uint8_t* src, uint8_t* dst,
                                 uint32_t src_len, uint32_t* p_dst_len);
SPDIF_RET_TYPE spdif_parser_read_with_sync(spdif_parser_handle handle, uint8_t* src, uint8_t* dst,
                                           uint32_t src_len, uint32_t* p_dst_len,
                                           uint32_t* p_out_src_pos);
...
SPDIF_RET_TYPE spdif_parser_set_default_word_length(spdif_parser_handle handle,
                                                    uint32_t word_length);
