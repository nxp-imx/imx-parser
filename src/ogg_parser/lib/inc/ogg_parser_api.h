...
EXTERN int32 OggCreateParser(bool isLive, FslFileStream* streamOps, ParserMemoryOps* memOps,
 ...
 * @return
 */
EXTERN int32 OggGetUserData(FslParserHandle parserHandle, uint32 userDataId, uint8** buffer,
                            uint32* size);
 ...
 * @return
 */
EXTERN int32 OggGetTrackType(FslParserHandle parserHandle, uint32 trackNum, uint32* mediaType,
...
EXTERN int32 OggGetVideoFrameRate(FslParserHandle parserHandle, uint32 trackNum, uint32* rate,
                                  uint32* scale);

// EXTERN int32 OggGetVideoFrameDuration(FslParserHandle parserHandle, uint32 trackNum, uint64
// *usDuration);
 ...
 * @return
 */
EXTERN int32 OggGetAudioNumChannels(FslParserHandle parserHandle, uint32 trackNum,
                                    uint32* numChannels);
 ...
 * @return
 */
EXTERN int32 OggGetAudioSampleRate(FslParserHandle parserHandle, uint32 trackNum,
                                   uint32* sampleRate);
 ...
 * @return
 */
EXTERN int32 OggGetAudioBitsPerSample(FslParserHandle parserHandle, uint32 trackNum,
 ...
 * @return
 */
EXTERN int32 OggGetTextTrackWidth(FslParserHandle parserHandle, uint32 trackNum, uint32* width);
 ...
 * @return
 */
EXTERN int32 OggGetTextTrackHeight(FslParserHandle parserHandle, uint32 trackNum, uint32* height);
 ...
 *
 */
EXTERN int32 OggSetReadMode(FslParserHandle parserHandle, uint32 readMode);
 ...
 * @return
 */
EXTERN int32 OggGetReadMode(FslParserHandle parserHandle, uint32* readMode);
 ...
 * @return
 */
EXTERN int32 OggEnableTrack(FslParserHandle parserHandle, uint32 trackNum, bool enable);
...
EXTERN int32 OggGetFileNextSample(FslParserHandle parserHandle, uint32* trackNum,
 ...
 */
EXTERN int32 OggSeek(FslParserHandle parserHandle, uint32 trackNum, uint64* usTime, uint32 flag);

EXTERN int32 OggParserGetDecSpecificInfo(FslParserHandle parserHandle, uint32 streamNum,
