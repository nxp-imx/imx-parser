...
typedef struct file_stream_s {
    ...
    int64 (*pf_fseek)(struct file_stream_s* stream, int64 offset, int32 whence,
                      void* context); /* whence: SEEK_SET, SEEK_CUR, or SEEK_END */
    int64 (*pf_ftell)(struct file_stream_s* stream,
                      void* context); /* get current pointer postion of the stream */
    int64 (*pf_fsize)(struct file_stream_s* stream,
                      void* context); /* get size of the entire file size */
